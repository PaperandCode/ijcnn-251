...
if __name__ == '__main__':
    model_list = ['LASSO,LR', 'LASSO,RF', 'LASSO,MLP', 'RF,LR', 'RF,RF', 'RF,MLP', 'MLP,LR', 'MLP,RF', 'MLP,MLP']
    ...
    #                     output='./ihdp_all.csv')
    for TE_name in ['ATE']:
        make_model_estimator_matrix(filename=TE_name+'_summary_error_stats_1000_test_all', model_list=model_list, estimator_list=estimator_list, error_name='weight_rel_error_avg')
        make_model_estimator_matrix(filename=TE_name+'_summary_error_stats_1000_test_all', model_list=model_list, estimator_list=estimator_list,
